...
export default function Navbarover({setMobile,setOtherwise}) {
  return (
    <div className='side-flex'>
      ...
      <div className='col-lg-3 -3 col-sm-3'>
            <img id='dp' src={img} alt="" />
      </div>
      <div className='col-lg-9 -9 col-sm-9'>
            <h6>Evano</h6>
            <p style={{fontSize:"60%"}}>Product Manager</p>
      </div>
     </div>
    </div>
  )
